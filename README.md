...
Click [here](https://github.com/flash-bitcoin-generator-software/flash-btc-apk) to visit the mobile repository.
...
```sh
git clone flash-bitcoin-generator-software/coin-flasher.git
```
